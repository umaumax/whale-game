...
export const THEMES = {
    fish: [
        { level: 1, name: "シラス", radius: Math.round(15 * SCALE), color: "#F5F5F5", score: 1, image: "assets/fish/01.png" },
        { level: 2, name: "アジ", radius: Math.round(24 * SCALE), color: "#87CEEB", score: 3, image: "assets/fish/02.png" },
        { level: 3, name: "ワカシ", radius: Math.round(33 * SCALE), color: "#98FB98", score: 6, image: "assets/fish/03.png" },
        { level: 4, name: "イナダ", radius: Math.round(42 * SCALE), color: "#FFD700", score: 10, image: "assets/fish/04.png" },
        { level: 5, name: "ワラサ", radius: Math.round(52 * SCALE), color: "#FFA500", score: 15, image: "assets/fish/05.png" },
        { level: 6, name: "ブリ", radius: Math.round(64 * SCALE), color: "#FF4500", score: 21, image: "assets/fish/06.png" },
        { level: 7, name: "タイ", radius: Math.round(76 * SCALE), color: "#FF69B4", score: 28, image: "assets/fish/07.png" },
        { level: 8, name: "カツオ", radius: Math.round(88 * SCALE), color: "#9370DB", score: 36, image: "assets/fish/08.png" },
        { level: 9, name: "マグロ", radius: Math.round(100 * SCALE), color: "#00008B", score: 45, image: "assets/fish/09.png" },
